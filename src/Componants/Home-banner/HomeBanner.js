    ...
    <div>
      <div className="position-relative">
            ...
            <div className="home-image ">
              ...
              <div className="container position-relative">
                    ...
                    <Tab eventKey="place" title="PLACES">
                      <div className="place-tab-one d-flex align-items-center">
                        ...
                        <div className="search-home-btn">
                          ...
                          >
                            Search
                            <FaSearch className="search-icon-tab" />
                          </button>
                        </div>
                      </div>
                    </Tab>
                ...
                <div className="hero-categories">
                  <h4 className="hero-categories-title position-relative">
        ...
        <div className="header-section-link">
          {showTopBtn1 && (
            <span className="custom-scroll-link" href="#a">
              <MdKeyboardDoubleArrowDown
                className="down-aarow"
                onClick={goTobottom}
              />
            </span>
          )}
      ...
      <div className="latest-section">
        <div className="latest-sec-title">
          ...
          <span className="section-separator"></span>
          <p>
            Mauris ac maximus neque. Nam in mauris quis libero sodales eleifend.
            Morbi varius, nulla sit amet rutrum elementum.
          </p>
        </div>
          ...
          <Slider {...settings}>
            <div className="px-2">
              <div className="listing-box position-relative overflow-hidden">
                <img
                  className="list-box-img  w-100 object-fit-cover"
                  src={img_one}
                  alt=""
                />
                <div className="list-card-box">
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="list-card-title">
                      <h4>
                        <a href="http://#">Shop in Aurora Center</a>
                      </h4>
                      <div className="list-location">
                        <a
                          ...
                          href="http://#"
                        >
                          <MdLocationPin className="location-pin" /> 40 Journal
                          Square Plaza, NJ, USA
                        </a>
                      </div>
                    </div>
              ...
              <div className="listing-box position-relative overflow-hidden">
                ...
                <div className="list-card-box">
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="list-card-title">
                      <h4>
                        <a href="http://#">The Goggi Restaurant</a>
                      </h4>
                      <div className="list-location">
                        <a
                          className="d-flex align-items-center gap-1"
                          href="http://#"
                        >
                          <MdLocationPin className="location-pin" /> 34-42
              ...
              <div className="listing-box position-relative overflow-hidden">
                ...
                <div className="list-card-box">
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="list-card-title">
                      <h4>
                        <a href="http://#">Gym in the Center</a>
                      </h4>
                      <div className="list-location">
                        <a
                          className="d-flex align-items-center gap-1"
                          href="http://#"
                        >
                          <MdLocationPin className="location-pin" /> 70 Bright
                          St New York, USA
                        </a>
                      </div>
                    </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 col-12 pt-4">
              <div className="listing-box w-100 position-relative overflow-hidden">
                <img
                  className="list-box-img  w-100 object-fit-cover"
                  src={explore_img_three}
                  alt=""
                />
                <div className="explore-title">
                  <h4 className="position-relative">
                    <a href="http://#">Moscow</a>
                  </h4>
                  <p>
                    Constant care and attention to the patients makes good
                    record
            ...
            <div className="col-lg-8 col-12 pt-4">
              <div className="listing-box w-100 position-relative overflow-hidden">
                <img
                  className="list-box-img  w-100 object-fit-cover"
                  src={explore_img_five}
                  alt=""
                />
                <div className="explore-title">
                  <h4 className="position-relative">
                    <a href="http://#">London</a>
                  </h4>
                  <p>
                    Constant care and attention to the patients makes good
                    record
          ...
          <div className="view-btn">
            <button className="view-all-btn">
              View All Cities
              <TiArrowRightOutline className="btn-icon" />
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="row">
            <div className="col-md-3 col-sm-6 col-12">
              <div className="counter-box position-relative z-1">
                <div className="counter-num" data-content="0" data-num="1440">
                  1254
                </div>
      ...
      <div className="most-place-section">
        <div className="latest-sec-title">
          ...
          <p>
            ...
            finibus tellus ut, convallis eros sollicitudin turpis.
          </p>
        </div>
        <div className="filter-select-btn d-flex justify-content-center align-items-center">
          ...
          <button
            value="All"
            onClick={handleBtns}
            className={activeBtn === 'All' ? 'active-tab' : ''}
          >
            All Categories
          </button>
          <button
            value="restaurant"
            onClick={handleBtns}
            className={activeBtn === 'restaurant' ? 'active-tab' : ''}
          >
            Restaurant
          </button>
          <button
            value="event"
            onClick={handleBtns}
            className={activeBtn === 'event' ? 'active-tab' : ''}
          >
            Event
          </button>
          <button
            value="fitness"
            onClick={handleBtns}
            className={activeBtn === 'fitness' ? 'active-tab' : ''}
          >
            Fitness
          </button>
          <button
            value="hotel"
            onClick={handleBtns}
            className={activeBtn === 'hotel' ? 'active-tab' : ''}
          >
            Hotel
          </button>
          {/* </ul> */}
          ...
          {category.map((item) => (
            <div className="cate-box-one" key={item.id}>
              <div className="cate-place-img cate-img-wrap position-relative overflow-hidden">
                ...
                <div
                  style={{ backgroundColor: item.open_color }}
                  className="open-close-btn green-bg d-flex align-items-center gap-2"
                >
                  {item.openicon}
                  {item.store}
                </div>
                <div className="review-rating d-flex align-items-center gap-3">
                  ...
                  <div>
                    <FaStar
                      className="text-yellow star-icon"
                      style={{ color: item.textyellow }}
                    />
                    <FaStar
                      className="text-yellow star-icon"
                      style={{ color: item.textyellow }}
                    ...
                    <FaStar
                      className="text-yellow star-icon"
                      style={{ color: item.textgrey_two }}
                    />
                    <FaStar
                      className="text-yellow star-icon"
                      style={{ color: item.textgrey }}
                    />
                    <FaStar
                      className="text-yellow star-icon"
                      style={{ color: item.textgrey }}
                ...
                <div className="listing-avatar">
                  ...
                  <div className="avtar-detail d-flex align-items-center">
                    <h4 className="m-0">
                      Added By <span>Alisa Noory</span>
                    </h4>
                  </div>
                </div>
              </div>
              <div className="cate-box-title position-relative">
                <div className="cate-title">
                  <h3 className="m-0 d-flex align-items-center gap-3">
                    {item.title}{' '}
                    <span style={{ backgroundColor: item.righticon_bg }}>
                      {item.righticon}
                    </span>{' '}
                  </h3>
                ...
                <div className="cate-text">
                  ...
                  <div className="facility-tab d-flex align-items-center gap-3">
                    ...
                    <ul className="list-unstyled m-0 d-flex align-items-center gap-2">
                      <li data-tooltip-id="my-tooltip-1">
                        <FaWifi />
                        <ReactTooltip
                      ...
                      <li data-tooltip-id="my-tooltip-2">
                        <TbParking />
                        <ReactTooltip
                          className="tooltip-style"
                          id="my-tooltip-2"
                      ...
                      <li data-tooltip-id="my-tooltip-3">
                        <FaSmokingBan />
                        <ReactTooltip
                          className="tooltip-style"
                          id="my-tooltip-3"
                          place="top"
                          variant="info"
                          content="No Smoking Rooms"
                        />
                      </li>
                      <li data-tooltip-id="my-tooltip-4">
                        <LiaDogSolid />
                        <ReactTooltip
                          className="tooltip-style"
                          id="my-tooltip-4"
                ...
                <div className="cate-footer d-flex justify-content-between align-items-center">
                  <div className="footer-rest d-flex align-items-center gap-2">
                    <div
                      className=" footer-circle d-flex justify-content-center align-items-center"
                      style={{
                        backgroundColor: item.rest_bg_color,
                        fontSize: '20px',
                      }}
                    >
                      {item.rest_icon}
                  ...
                  <div className="footer-list">
                    <ul className="m-o list-unstyled d-flex align-items-center gap-2">
                      ...
                      <li data-tooltip-id="my-tooltip-6">
                        <MdOutlineLocationOn
                          onClick={handleShow}
                          className="far"
                        />
                      ...
                      <li data-tooltip-id="my-tooltip-7">
                        <MdZoomIn className="far" />
                        <ReactTooltip
                          className="tooltip-style"
                          id="my-tooltip-7"
                          place="top"
                    ...
                    <div className="contact-info-show position-absolute">
                      <div className="contact-details position-relative">
                        <ul className="m-0 list-unstyled">
                          <li>
                            <span>
                              <FaPhone className="footer-contact-icon" /> Call :{' '}
                            </span>
                            <a href="http://#">+38099231212</a>
                          </li>
                          <li>
                            <span>
                              <MdOutlineMail className="footer-contact-icon" />{' '}
                              Write :{' '}
                            </span>
                            <a href="http://#">yourmail@domain.com</a>
                          </li>
                        </ul>
                        <div
                          className="footer-close position-absolute   d-flex justify-content-center align-items-center"
      ...
      <div className="promo-video">
        <div className="promo-title text-center">
          ...
          <h2>
            Get ready to start your exciting journey. <br /> Our agency will
            lead you through the amazing digital world
          </h2>
          ...
          <div className="row">
            <div className="col-lg-6 col-12">
              <div className="app-title">
                ...
                <div className="app-btn-main d-flex gap-4 mt-4">
                  <button className="m-0 down-btn position-relative text-center w-100">
                    <IoLogoApple className="play-icon position-absolute" />
                    App Store
                  </button>
                  <button className="m-0 down-btn position-relative text-center w-100">
                    <DiAndroid className="play-icon position-absolute" />
                    Play Store
                  </button>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-12">
              <div className="college-image position-relative text-center">
                ...
                <div className="book-box green-bg text-white position-absolute">
                  Booking now
                </div>
                <div className="input-text bg-white d-flex justify-content-between align-items-center position-absolute">
                  Search
                  <FaSearch className="search-icon m-0 fs-6" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="test-section">
        <div className="latest-sec-title">
          ...
          <span className="section-separator"></span>
          <p>
            Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar. Donec a
            consectetur nulla.
          </p>
        </div>
      ...
      <div className="wave-section position-relative">
        <div className="wave-img position-absolute"></div>
      </div>
      ...
      <div className="maps-open-box">
        ...
        >
          ...
          <Modal.Body>
            <div>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d52808140.21705447!2d-161.46429918210544!3d36.11412792251988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited%20States!5e0!3m2!1sen!2sin!4v1713617400700!5m2!1sen!2sin"
                width="470"
                height="450"
                allowfullscreen=""
                loading="lazy"
