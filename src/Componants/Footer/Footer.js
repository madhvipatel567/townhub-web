        ...
        <div className="row">
          <div className="col-lg-4 col-12 mt-lg-0 mt-3">
            ...
            <div className="footer-contact">
              ...
              <ul className="m-0 list-unstyled">
                <li>
                  <MdOutlineEmail className="contact-icon" /> Mail :{' '}
                  <a href="http://#">yourmail@domain.com</a>
                </li>
                <li>
                  <CiLocationOn className="contact-icon" /> Address :
                  <a href="http://#">USA 27TH Brooklyn NY</a>
                </li>
                <li>
                  <FiPhone className="contact-icon" /> Phone :
                  <a href="http://#">+7(111)123456789</a>
                </li>
              </ul>
            </div>
            ...
            <div className="our-last-news">
              ...
              <div className="row">
                ...
                <div className="col-md-9 col-sm-8 col-8 mt-2">
                  <div className="footer-card-title">
                    ...
                    <p className="d-flex gap-2 m-0">
                      {' '}
                      <FaRegCalendarAlt className="cal-icon" /> 21 Mar 09.05{' '}
                    </p>
                    <hr />
                  </div>
                </div>
                ...
                <div className="col-md-9 col-sm-8 col-8 mt-2">
                  <div className="footer-card-title">
                    ...
                    <p className="d-flex gap-2 m-0">
                      {' '}
                      <FaRegCalendarAlt className="cal-icon" /> 7 Mar 18.21{' '}
                    </p>
                    <hr />
                  </div>
                </div>
                ...
                <div className="col-md-9 col-sm-8 col-8 mt-2">
                  <div className="footer-card-title">
                    ...
                    <p className="d-flex gap-2 m-0">
                      {' '}
                      <FaRegCalendarAlt className="cal-icon" /> 7 Mar 16.42{' '}
                    </p>
                    <hr />
                  </div>
                </div>
              ...
              <div className="read-title">
                <span className="d-flex align-items-center gap-2">
                  Read All <FaLongArrowAltRight className="arro-right" />
                </span>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-12 mt-lg-0 mt-3">
            ...
            <div className="app-link d-flex flex-column">
              <a
                className="download-btn w-100 text-center position-relative"
                href="http://#"
              >
                <FaApple className="download-icon  position-absolute" />
                Apple Store
              </a>
              <a
                className="download-btn w-100 text-center position-relative"
                href="http://#"
              >
                <ImAndroid className="download-icon position-absolute" />
                Play Store
              </a>
            </div>
          </div>
